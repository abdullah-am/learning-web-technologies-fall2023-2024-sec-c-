			  ...
			  <td>
				<table border="1"   width="100%">
					<tr>
						...
						<td >
                            <form  method="post" action="../controller/deletecheak.php" enctype="">
                               <h1>Delete Your Account</h1>

                                <label>Confirm deletion by entering your password:</label><br>
                                <input type="password" name="currentpassword" value="" required/><br>
